    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">{{trans('lang.banner_create')}}</h3>
            </div>
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{trans('lang.banner_create')}}</li>
                </ol>
            </div>
                ...
                <div class="col-12">
                    <div class="card pb-4">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('banners.store')}}" method="post" enctype="multipart/form-data" id="create_category">
                                @csrf

                                <div class="row restaurant_payout_create">
                                    <div class="restaurant_payout_create-inner">
                                        <fieldset>
                                            <legend>{{trans('lang.banner_create')}}</legend>
