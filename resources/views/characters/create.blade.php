    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">{{trans('lang.character_create')}}</h3>
            </div>

            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                    <li class="breadcrumb-item"><a href="{!! route('characters') !!}">{{trans('lang.characters')}}</a></li>
                    <li class="breadcrumb-item active">{{trans('lang.character_create')}}</li>
                </ol>
            </div>
                ...
                <div class="col-12">
                    <div class="card pb-4">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('characters.store')}}" method="post" enctype="multipart/form-data" id="create_category">
                                @csrf

                                <div class="row restaurant_payout_create">
                                    <div class="restaurant_payout_create-inner">
                                        <fieldset>
                                            <legend>{{trans('lang.character_create')}}</legend>
                                            ...
                                            <div class="form-check  width-50">
                                                <input type="checkbox" class="" name="lock" id="lock">
                                                <label class="col-3 control-label" for="lock">{{trans('lang.lock')}}</label>
                                            </div>
