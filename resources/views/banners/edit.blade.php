...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">{{trans('lang.banner_edit')}}</h3>
        </div>

        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                <li class="breadcrumb-item"><a href="{!! route('banners') !!}">{{trans('lang.banners')}}</a>
                </li>
    ...
    <div class="container-fluid">
        ...
        <div class="card pb-4">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('banners.update',$banners->id) }}"
                    ...
                    <div class="row restaurant_payout_create">
                        <div class="restaurant_payout_create-inner">
                            ...
                            <fieldset>
                                ...
                                <legend>{{trans('lang.banner_edit')}}</legend>

                                <div class="form-group row width-50">
                                    <label class="col-3 control-label">{{trans('lang.banner_name')}}</label>
                                    <div class="col-7">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    @if (file_exists(public_path('images/banners'.'/'.$banners->photo)) &&
                                    !empty($banners->photo))
                                    <img class="rounded" id="uploding_image" style="width:50px"
                                        src="{{asset('images/banners').'/'.$banners->photo}}" alt="image">
                                    @else
                                    <img class="rounded" id="uploding_image" style="width:50px"
