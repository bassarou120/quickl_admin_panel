    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{!! route('languages') !!}">{{trans('lang.languages')}}</a>
                </li>
                        ...
                        <div class="restaurant_payout_create-inner">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control" name="code" value="{{$languages->code}}">
                                    </div>
                                </div>

                                <div class="form-group row width-100">
                                    <label class="col-2 control-label">{{trans('lang.language_image')}}</label>
                                    <input type="file" class="col-6 photo" name="photo" onchange="readURL(this);">
                                    @if (file_exists(public_path('images/languages'.'/'.$languages->photo)) &&
                                    !empty($languages->photo))
                                    <img class="rounded" id="uploding_image" style="width:50px"
                                        src="{{asset('images/languages').'/'.$languages->photo}}" alt="image">
                                    @endif
                                ...
                                <div class="form-group row width-50">
                                    <div class="form-check">
                                        @if ($languages->is_rtl === "yes")
                                        <input type="checkbox" class="is_rtl" name="is_rtl" id="is_rtl"
                                            checked="checked">
                                        @else
                                        <input type="checkbox" class="is_rtl" name="is_rtl" id="is_rtl">
                                        @endif
